...
export function ComingSoonWorkspace({
  ...
  return (
    ...
    >
      <div className="flex max-w-md flex-col items-center gap-2 rounded-lg border border-border bg-card px-6 py-8">
        <p className="m-0 text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground">
          Coming soon
        </p>
