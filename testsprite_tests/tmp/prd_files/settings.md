...
5. Data: counts + Clear History / Drafts / All (envs included on Clear All; collections **not**
...
Opened via `title="Settings (⌘,)"`. `settings-word-wrap`. Nav/theme by button labels
